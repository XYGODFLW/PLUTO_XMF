...
/* ********************************************************************* */
void hd_HLL_Speed (double **vL, double **vR, double *a2L, double *a2R,
...
/* ----------------------------------------------
   ...
   hd_MaxSignalSpeed (vL, a2L, sl_min, sl_max, beg, end);
   hd_MaxSignalSpeed (vR, a2R, sr_min, sr_max, beg, end);
   for (i = beg; i <= end; i++) {
