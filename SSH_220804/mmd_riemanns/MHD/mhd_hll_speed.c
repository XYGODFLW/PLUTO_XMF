...
/* ********************************************************************* */
void mhd_HLL_Speed (double **vL, double **vR, double *a2L, double *a2R, double **bgf, 
 ...
 *********************************************************************** */
{
  ...
  if (sl_min == NULL){
    vm = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
...
/* ----------------------------------------------
   ...
   mhd_MaxSignalSpeed (vL, a2L, sl_min, sl_max, bgf, beg, end);
   mhd_MaxSignalSpeed (vR, a2R, sr_min, sr_max, bgf, beg, end);
