 ...
 *********************************************************************** */
{
  ...
  /* ---- assign bx at i_f, j, k  ---- */
   ...
   Init_f0 (us_p, x1f, x2p, x3);
   Init_f0 (us_m, x1f, x2m, x3);

   bx = (us_p[AX3] - us_m[AX3])/dx2;

   #if DIMENSIONS == 3
    Init_f0 (us_p, x1f, x2, x3p);
    Init_f0 (us_m, x1f, x2, x3m);
  ...
  /* ---- assign by at i, j_f, k  ---- */
   ...
   Init_f0 (us_p, x1p, x2f, x3);
   Init_f0 (us_m, x1m, x2f, x3);

   by = -(us_p[AX3] - us_m[AX3])/dx1;

   #if DIMENSIONS == 3
    Init_f0 (us_p, x1, x2f, x3p);
    Init_f0 (us_m, x1, x2f, x3m);
  ...
  /* ---- assign bz at i, j, k_f  ---- */
   ...
   Init_f0 (us_p, x1p, x2, x3f);
   Init_f0 (us_m, x1m, x2, x3f);
   
   bz = (us_p[AX2] - us_m[AX2])/dx1;

   Init_f0 (us_p, x1, x2p, x3f);
   Init_f0 (us_m, x1, x2m, x3f);
  ...
  /* ---- assign bphi at i, j, k ---- */  /* -- Only non STAG-- */
    ...
    bphi = 0.0;
   #else
    Init_f0 (us_p, x1, x2p, x3);
    Init_f0 (us_m, x1, x2m, x3);
    
    bphi = (us_p[AX1] - us_m[AX1])/dx2;
    
    Init_f0 (us_p, x1p, x2, x3);
    Init_f0 (us_m, x1m, x2, x3);
