...
/* -- eigenvectors -- */
  ...
  state->Lp      = ARRAY_3D(NMAX_POINT, MHD_NFLX, MHD_NFLX, double);
  state->Rp      = ARRAY_3D(NMAX_POINT, MHD_NFLX, MHD_NFLX, double);
  state->lambda  = ARRAY_2D(NMAX_POINT, MHD_NFLX, double);
