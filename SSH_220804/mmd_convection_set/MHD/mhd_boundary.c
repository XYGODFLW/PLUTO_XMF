...
/* ********************************************************************* */
void mhd_Boundary (const Data*d, int idim, Grid *grid)
/*!
 ...
 *********************************************************************** */
{
  ...
  int  type[6], sbeg, send, vsign[MHD_NVAR];
  int  par_dim[3] = {0, 0, 0};
  double ***q;
  
  UserDefBoundary *userBC;
 ...
 *********************************************************************** */
{
  ...
  int Bn, Bp, Bt;
   ...
   for (nv = 0; nv < MHD_NVAR; nv++) vsign[nv] = 1.0;
   return;
  #endif
