...
#define CONST_RJup    6.99e9             /**<  Jupiter Radius.            */
#define CONST_sigma   5.67051e-5         /**<  Stephan Boltmann constant. */
#define CONST_sigmaT  6.6524e-25         /**<  Thomson Cross section.     */
#define CONST_sigmaHI 1.8866e-18         /**<  Cross section for photoionization of HI  */
/**@} */
...
#include "plm_coeffs.h"      /* PLM header file */
...
#endif
extern long int KNP_GLOB;
extern long int JNP_GLOB;
extern long int INP_GLOB;
