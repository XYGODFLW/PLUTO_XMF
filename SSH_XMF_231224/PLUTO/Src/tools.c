...
/* ********************************************************************* */
int hd_CheckNaN (double **u, int is, int ie, int id)
/*!
...
int mhd_CheckNaN (double **u, int is, int ie, int id)
/*!
 * Cheeck whether the array \c u contains Not-a-Number
 *  (NaN)
 *
 ...
 *********************************************************************** */
{
  ...
  state->v       = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->vp      = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->vm      = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->up      = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->um      = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->flux    = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);

  state->src     = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->visc_flux = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->visc_src  = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->tc_flux   = ARRAY_2D(NMAX_POINT, MHD_NVAR, double); 
 
  state->res_flux  = ARRAY_2D(NMAX_POINT, MHD_NVAR, double); 

  state->rhs     = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
...
/* -- eigenvectors -- */
  ...
  state->Lp      = ARRAY_3D(NMAX_POINT, MHD_NVAR, MHD_NVAR, double);
  state->Rp      = ARRAY_3D(NMAX_POINT, MHD_NVAR, MHD_NVAR, double);
  state->lambda  = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  state->lmax    = ARRAY_1D(MHD_NVAR, double);
...
/* --------------------------------------
  ...
  state->uR = state->um + 1;
   ...
   state->vh = ARRAY_2D(NMAX_POINT, MHD_NVAR, double);
  #else
   state->vh = state->v;
  #endif
