...
/*! 
  ...
  \date   June 21, 2014
  Adjusted for XMF 20230901(by Xing)
*/
 ...
 * adjusted for XMF output(by xing 20230831)
 *********************************************************************** */
{
  FILE *fp;
 ...
 *********************************************************************** */
{
  fwrite (V, dsize, KNP_GLOB*JNP_GLOB*INP_GLOB, fl);
}
 ...
 * adjusted for XMF output(by xing 20230901)
 *********************************************************************** */
{
  int i, j, k;
  float  flt;
  ...
  if (Vflt == NULL) Vflt = ARRAY_3D(KNP_GLOB, JNP_GLOB, INP_GLOB, float);
