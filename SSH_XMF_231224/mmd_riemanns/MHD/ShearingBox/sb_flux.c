 ...
 *********************************************************************** */
{
  ...
  if (FluxL == NULL){
    FluxL = ARRAY_3D(MHD_NVAR, NX3_TOT, NX2_TOT, double);
    FluxR = ARRAY_3D(MHD_NVAR, NX3_TOT, NX2_TOT, double);
  }
 ...
 *********************************************************************** */
{
  ...
  if (fL == NULL){
    fL   = ARRAY_2D(MHD_NVAR, NMAX_POINT, double);
    fR   = ARRAY_2D(MHD_NVAR, NMAX_POINT, double);
    Ftmp = ARRAY_4D(MHD_NVAR, NX3_TOT, NX2_TOT, 1, double);
  }
...
/* -----------------------------------------------------------------------
  ...
  #ifdef PARALLEL
   ExchangeX (FluxL[0][0], FluxR[0][0], MHD_NVAR*NX2_TOT*NX3_TOT, grid);
  #endif
