...
/* *********************************************************************** */
void mhd_PrimRHS (double *v, double *dv, double cs2, double h, double *Adv)
/*!
...
/* ********************************************************************* */
void mhd_PrimSource (const State_1D *state, int beg, int end, double *a2, 
...
/* ----------------------------------------------------------
  ...
  memset((void *)src[0], '\0',NMAX_POINT*MHD_NVAR*sizeof(double));
