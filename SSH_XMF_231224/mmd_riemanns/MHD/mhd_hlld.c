...
/* ********************************************************************* */
void mhd_HLLD_Solver (const State_1D *state, int beg, int end, 
 ...
 *********************************************************************** */
{
  int    nv, i;
  int    revert_to_hllc;
  double   scrh, Uhll[MHD_NFLX];

  double usL[MHD_NFLX], ussl[MHD_NFLX];
  double usR[MHD_NFLX], ussr[MHD_NFLX];
...
/* ----------------------------------------------------
  ...
  mhd_Flux (UL, VL, a2L, bgf, fL, ptL, beg, end);
  mhd_Flux (UR, VR, a2R, bgf, fR, ptR, beg, end);
...
/* ----------------------------------------
  ...
  mhd_HLL_Speed (VL, VR, a2L, a2R, bgf, SL, SR, beg, end);
 ...
 *********************************************************************** */
{
  ...
  int  revert_to_hll;
  double scrh;
  double usL[MHD_NFLX], *SL;
  double usR[MHD_NFLX], *SR;
  double usc[MHD_NFLX];
